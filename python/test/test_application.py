...
class TestApplication(unittest.TestCase):
    def test_run(self):
        ...
        self.assertEqual(Application(branch_name).run(), '[service] This Is A Test Branch')

    def test_run_in_the_case_of_hotfix(self):
        branch_name = 'hayat01sh1da/issue-xxxxx/hotfix/service/this_is_a_test_branch'
        self.assertEqual(Application(branch_name).run(), '[Hotfix][service] This Is A Test Branch')
